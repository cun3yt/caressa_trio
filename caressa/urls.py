...
from actions.api.views import ActionViewSet, CommentViewSet, ReactionViewSet, laugh_at_joke, findinteresting_at_news
...
urlpatterns = [
    ...
    path('findinteresting/', findinteresting_at_news)
]
