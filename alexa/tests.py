...
from alexa.models import User, AUser
...
class CircleMembershipModelTestCase(TestCase):
    pass


class AUserModelTestCase(TestCase):
    def setUp(self):
        self.User_recipe = Recipe(
            User,
        ...
        self.AUser_recipe = Recipe(
            AUser,
            alexa_id='TestAlexaId1',
            user=foreign_key(self.User_recipe),
            engine_schedule='TestEngineSchedule',  # todo Is it needed run script here?
            profile='{}'
        )
