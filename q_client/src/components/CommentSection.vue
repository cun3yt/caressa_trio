<template>
  <div class="main">
    ...
    <q-item>
      <q-item-main>
        <q-input :max-height="50" v-model="new_comment" clearable type="textarea"
                 class="new-comment" name="new-comment" :placeholder="placeholder">
...
export default {
  ...
  computed: {
    placeholder () {
      return (this.comments.count === 0) ? 'Be first to comment' : 'Write your comment'
    },
    isOverLimit () {
